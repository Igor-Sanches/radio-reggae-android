...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public static final String ACTION_PLAY = "br.com.pampa.osul.player.ACTION_PLAY";
    public static final String ACTION_PAUSE = "br.com.pampa.osul.player.ACTION_PAUSE";
    public static final String ACTION_STOP = "br.com.pampa.osul.player.ACTION_STOP";
    ...
    private String radioName = "Rádio Online";
    ...
    public void onChanged(float volume) {
    ...
    public void onCreate() {
        ...
        notificationManager = new MediaNotificationManager(this, radioName);
    ...
    public void onAudioFocusChange(int focusChange) {
         switch (focusChange) {
            case AudioManager.AUDIOFOCUS_GAIN:
                exoPlayer.setVolume(Data.getVolume(this));
                resume();
                 break;
